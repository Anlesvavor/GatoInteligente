...
public class Test {
    ...
    public void prueba6(){
        ...
        tmp = new NodeGato(new Jugada(EnumTurno.COMPUTADORA, EnumGanador.POR_DEFINIR, simbolo, r5));
        ...
        //raiz.breadthRejaSearch(new Reja()).getNode().getChildren().forEach(System.out::println);
    }

    @org.junit.jupiter.api.Test
    public void popularArbolTest() {
        NodeGato raiz = GatoCLI.popularArbol(75);
        EnumEstado simbolo = EnumEstado.X;
        Reja r = new Reja().ingresar(0,0, EnumEstado.X);
        ...
        if (raiz.breadthRejaSearch(r).getNode().depthGanadorSearch(simbolo).getNode() != null) {
            System.out.println(raiz.breadthRejaSearch(r).getNode().depthGanadorSearch(simbolo).getRoute().get(1).getData().getReja());
        }
